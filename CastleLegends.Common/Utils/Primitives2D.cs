...
namespace CastleLegends.Common.Utils
{
    ...
    public static class Primitives2D
    {
        ...
        private static readonly Dictionary<String, List<Vector2>> pointsCache = new Dictionary<string, List<Vector2>>();
        ...
        private static List<Vector2> CreateCircle(double radius, int sides)
        {
            ...
            if (pointsCache.ContainsKey(circleKey))
            {
                return pointsCache[circleKey];
            }
            ...
            pointsCache.Add(circleKey, vectors);
        ...
        /// <summary>
        /// Creates a list of vectors that represents an hexagon
        /// </summary>
        ...
        private static List<Vector2> CreateHexagon(float radius, HexTileType type)
        {
            ...
            // Cache this circle so that it can be quickly drawn next time
            pointsCache.Add(cacheKey, vectors);
